		...
		$data = [
			...
			'facebook'               => [
				...
				'CSV'  => [
					...
					'video_url_0'                  => array( 'video[0].url', true ),
					'video_url_1'                  => array( 'video[1].url', true ),
					'video_url_2'                  => array( 'video[2].url', true ),
					'video_url_3'                  => array( 'video[3].url', true ),
					'video_url_4'                  => array( 'video[4].url', true ),
				],
				'JSON' => [],
			],
			'pinterest'              => [
