    ...
    $( document ).ajaxComplete(function( event, xhr, settings ) {
        ...
        /*-------------*/
            ...
            var elementExists = Object.keys(dataObj).some(function(key) {
                return dataObj[key] === "et_wishlist";
            });

        /* Edit element
        /*-------------*/

            if(dataObj['action'] == "vc_edit_form" && dataObj['tag'] == "et_wishlist"){

                var edit_element = $('#vc_ui-panel-edit-element[data-vc-shortcode="et_wishlist"]');
                ...
                $('#vc_ui-panel-edit-element[data-vc-shortcode="et_wishlist"] .vc_ui-button-action[data-vc-ui-element="button-save"]').on('click',function(){

                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_wishlist"]').length) {

                        var CSS = '';
                        var ID  = uniqueID();

                        edit_element = $('#vc_ui-panel-edit-element[data-vc-shortcode="et_wishlist"]');
                        ...
                        ---------------*/
                            ...
                            if (icon_color.length) {
                                CSS += '#wishlist-toggle-'+ID+' dir-child* svg {';
                                    CSS += 'fill:'+icon_color+';';
                                CSS += '}';
                            }

                            CSS += '#wishlist-toggle-'+ID+' {';
                            ...
                            if (text_color.length) {
                                CSS += '#wishlist-toggle-'+ID+' .wishlist-contents {';
            ...
            if((dataObj['action'] == "vc_load_shortcode" && elementExists)){
                ...
                if (typeof(iframe) != 'undefined' && iframe != null){
                    iframe.ready(function() {
                        ...
                        var element = doc.find('.vc_element[data-model-id="'+dataObj['shortcodes[0][id]']+'"] .header-wishlist');
