                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_logo"]').length) {
                        ...
                        ---------------*/
                            ...
                            if(logo.length){
                                ...
                                var logo_preview     = edit_element.find("img[rel=\""+logo+"\"]"),
                                    logo_preview_src = logo_preview.attr("src");
                            ...
                            if(sticky_logo.length){
                                ...
                                var sticky_logo_preview     = edit_element.find("img[rel=\""+sticky_logo+"\"]"),
                                    sticky_logo_preview_src = sticky_logo_preview.attr("src");
